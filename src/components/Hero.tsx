...
import { ArrowRight, Shield, Users, Heart, Zap, Star, CheckCircle, Sparkles, Globe } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Transparent trust system',
      color: 'blue'
    },
    {
      icon: Zap,
      title: 'AI-Powered Support',
      description: 'Instant 24/7 assistance',
      color: 'yellow'
    },
    {
      icon: Globe,
      title: 'Global Community',
      description: '120+ countries served',
      color: 'green'
    },
    {
      icon: Heart,
        ...
        >
         ...
         //   animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <button className="inline-flex items-center px-10 py-5 border-3 border-blue-600 text-blue-600 hover:bg-blue-50 font-bold text-lg rounded-2xl transition-all duration-300 transform hover:scale-105">
              Browse Helpers
